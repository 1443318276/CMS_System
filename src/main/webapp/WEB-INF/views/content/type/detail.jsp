...
<body>
<form action="master/editContentTypeDetail.do" method="post" class="container-fluid">
    <input type="hidden" name="id" value="${editItem.id}">
    <textarea name="pageContent" class="d-none">${editItem.typeContent}</textarea>
    <div id="pageContent" class="content ">${editItem.typeContent} </div>
</form>
