    ...
    ($ => {
        ...
        $(() => {
            table.bootstrapTable({
                url: "master/userRouterRuleData.do", // 获取数据的ajax请求接口
                queryParams(params) {
            ...
            $("#toolbar").on("click", "button", function (e) {
                ...
                if (target.hasClass("add-item")) {
                    ...
                    $.peanutPage.modal({
                        title: "新增角色权限信息",
                        url: "master/userRouterRuleEdit.do"
                    });
                } else if (target.hasClass("del-checked")) {
                    //删除所选项
                    $.peanutPage.delElement({
                        title: "删除警告",
                        text: "是否确认删除当前选中的角色权限",
                        url: "master/delUserRouterRule.do",
                        table: "#bootstrapTable"
                    });
                }
            });
        ...
        window.actionEvents = {
            "click .edit": function (e, value, row, index) {
                ...
                $.peanutPage.modal({
                    title: "修改角色权限信息",
                    url: "master/userRouterRuleEdit.do?id=" + row.id
                });
            },
